...
class BaselineCNN(nn.Module):
    def __init__(self, num_classes=10, in_channels=3, embed_dim=64):
        super().__init__()
...
def main():
    ...
    print(f"Training CIFAR-10 Baseline on {device}...")
    ...
    model = BaselineCNN(num_classes=10, in_channels=3).to(device)
    ...
    for epoch in range(15):
        ...
        print(f"Epoch [{epoch+1}/15] | Test Acc: {correct/total:.4f}")
